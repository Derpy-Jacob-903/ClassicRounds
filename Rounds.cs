...
#pragma warning disable IDE1006
    public class EasyBtd3Rounds : ModRoundSet
    {
        ...
        /// <summary>
        /// A string that affect
        /// </summary>
        public virtual string diff => "easy";
        ...
        {
            string[] ranks = [BloonID<ClassicRed>(), BloonID<ClassicBlue>(), BloonID<ClassicGreen>(), BloonID<ClassicYellow>(), BloonID<ClassicBlack>(), BloonID<ClassicWhite>(), BloonID<ClassicLead>(), BloonID<ClassicRainbow>(), BloonID<ClassicCeramic>(), BloonID<ClassicMoab>()];
    ...
    public class EasyBtd4Rounds : ModRoundSet
    {
        protected override int Order => 3;
        ...
        /// <param name="delay">Corresponds to the BloonGroup's startTime.</param>
        /// <returns></returns>
        public float ABSTL(int bloonCount, int bloonRank, int curLevel, RoundModel roundModel, float delay)
        {
    ...
    public class MidBtd3Rounds : EasyBtd3Rounds
    {
    ...
    public class Btd4ApopRounds : EasyBtd4Rounds
    {
        public override string diff => "medium";
