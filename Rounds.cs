...
public class Btd3Rounds : ModRoundSet
{
    ...
    {
        string[] ranks = ["Red", "Blue", "Green", "Yellow", "Black", "White", "Lead", "Rainbow", "Ceramic", "Moab"];
        string[] expertRanks = ["Blue", "Green", "Yellow", "White", "Lead", "Rainbow", "Lead", "RainbowRegrow", "CeramicFortified", "MoabFortified"]; //60-79
        string[] freeplayRanks = ["Blue", "Green", "Yellow", "White", "Black", "White", "Lead", "Rainbow", "Ceramic", "Moab"]; //80+
        string[] altFreeplayRanks = ["BlueRegrow", "GreenRegrow", "YellowRegrow", "WhiteRegrow", "BlackRegrow", "WhiteRegrow", "LeadRegrow", "RainbowRegrow", "CeramicRegrow", "Ddt"]; //90, 93, 95, 97, 99, 100, 101, 103, 105 etc.
    ...
    public override void ModifyRoundModels(RoundModel roundModel, int round)
    {
        ...
        switch (round)
        {
            ...
            default:
                ...
                {
                    ModHelper.Warning<ClassicRounds.ClassicRoundsMod>("Round " + round + 1 + ": Missing round data, sending some browns");
